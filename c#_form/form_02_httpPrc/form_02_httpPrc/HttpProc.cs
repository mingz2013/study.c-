...
namespace form_02_httpPrc
{
    ...
    ///<param name="e"></param>
    public delegate void WebClientUploadEvent(object sender, form_02_httpPrc.UploadEventArgs e);
    ...
    ///<param name="sender"></param>
    ///<param name="e"></param>
    public delegate void WebClientDownloadEvent(object sender, form_02_httpPrc.DownloadEventArgs e);
