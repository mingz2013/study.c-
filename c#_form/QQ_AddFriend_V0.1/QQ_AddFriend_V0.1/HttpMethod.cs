...
namespace QQ_AddFriend_V0._1
{
    class HttpMethod
    {
        ...
        // 通过POST方式发送数据
        public string SendDataByPost(string strUrl, string postDataStr,string ProxyIP = null, int ProxyPort = 0, string referer = null)
        {
           ...
           // request.ReadWriteTimeout = iTimeOut;
            ...
            {
                WebProxy webPro = new WebProxy(ProxyIP, ProxyPort);
        ...
        // 通过GET方式发送数据
        public Stream SendDataByGETtoStream(string strUrl,string referer = null, string ProxyIP = null, int ProxyPort = 0 )
        {
        ...
        // 通过GET方式发送数据
        public string SendDataByGETtoString(string strUrl, string referer = null, string ProxyIP = null, int ProxyPort = 0, string encoding = "utf-8")
        {
            string retString;
            
                Stream myResponseStream = SendDataByGETtoStream(strUrl, referer, ProxyIP, ProxyPort);
